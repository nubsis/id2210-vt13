...
public final class Search extends ComponentDefinition {
    ...
    private void triggerSearch(WebRequest request, String query) {
        ...
        ScheduleTimeout to = new ScheduleTimeout(SearchConfiguration.SEARCH_REQUEST_TIMEOUT);
        ...
        public void handle(AddIndexText event) {
            ...
            synchronized (sync) {
                ...
                if (selfPid != eventPid) {
                    ...
                    if (route != null) {
                        logger.log("R :: Adding index entry: " + event.getText()
                                + "; routing request to " + route + "[" + eventPid
                                + "]");
                        ...
                        logger.log("RL :: Adding index entry: " + event.getText()
                                + "; routing request through leader " + leader + "[" + selfPid
                                + "]");
