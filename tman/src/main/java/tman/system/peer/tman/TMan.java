...
public final class TMan extends ComponentDefinition {
	...
	subscribe(election.getHandlerRefute(), networkPort);
    ...
    //-------------------------------------------------------------------	
    private final Handler<TManInit> handlerInit = new Handler<TManInit>() {
	@Override
    ...
    //-------------------------------------------------------------------	
    private final Handler<TManSchedule> handlerRound = new Handler<TManSchedule>() {
	@Override
    ...
    //-------------------------------------------------------------------	
    private final Handler<Ping.Request> handlerPingRequest = new Handler<Ping.Request>() {
	@Override
